    ...
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <ul>
          ...
          <li>Start Investigating! Hit "Open Investigation" to begin</li>
          <li>Pick a Country: Choose where you want to investigate</li>
          <li>Select Your Case: Pick an interesting case file</li>
          <li>Read the Case Brief: Get the scoop on the news story, check out the full article if you want, click "See Photos" when ready</li>
